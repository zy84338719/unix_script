...
**macOS / Linux 服务与环境一键管理脚本库** — 66 个模块，统一子命令接口，覆盖服务部署、系统初始化、开发环境、AI 工具、系统运维全场景。支持 **x86_64 / ARM64 / ARMv7** 三大架构，适配银河麒麟 / 统信 UOS 等国产发行版。

> 当前版本：[VERSION](VERSION)（v1.18.0） · 更新日志：[CHANGELOG.md](CHANGELOG.md) · AI 接口说明：[AGENTS.md](AGENTS.md)
...
- **66 个模块**：服务 / 装机必备 / 开发环境 / AI 工具 / 系统工具，5 大分类全覆盖
...
| [1panel](services/1panel) | 新一代 Linux 服务器运维面板（v2） | 1p | ✅ | ❌ |
| [btpanel](services/btpanel) | 宝塔 Linux 运维面板（en 装 aaPanel 国际版） | bt | ✅ | ❌ |
| [webmin](services/webmin) | 经典 Web 系统管理面板（官方仓库） | — | ✅ | ❌ |
| [casaos](services/casaos) | 家庭云/NAS 轻量面板（Docker 应用商店） | — | ✅ | ❌ |
